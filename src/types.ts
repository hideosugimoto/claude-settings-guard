...
export type IssueCode = 'LEGACY_SYNTAX' | 'STRUCTURE_ISSUE' | 'CONFLICT' | 'ALLOW_ASK_CONFLICT' | 'ALLOW_DENY_CONFLICT' | 'BARE_TOOL_OVERRIDE' | 'INVALID_TOOL' | 'INVALID_PATTERN' | 'PIPE_VULNERABLE' | 'MISSING_PAIRED_DENY' | 'CROSS_TOOL_BYPASS' | 'PREFIX_BYPASS_RISK'
